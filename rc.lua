...
globalkeys = gears.table.join(
    ...
    awful.key({modkey,"Shift"},"s",function() 
            awful.spawn("gnome-screenshot",false) 
    ...
    -- Prompt
    awful.key({ modkey },            "r",     function () awful.util.spawn(rofi_cmd)  end,
...
for i = 1,#tags do
    globalkeys = gears.table.join(globalkeys,
        ...
        awful.key({ modkey, "Shift" }, i,
                  ...
                  {description = "move focused client to "..tags[i], group = "tag"}),
        ...
        awful.key({ modkey, "Control", "Shift" },i,
                  ...
                  {description = "toggle focused client on " .. tags[i], group = "tag"})
    )
end
...
globalkeys = gears.table.join(globalkeys,
	awful.key({},"XF86AudioRaiseVolume",function() awful.util.spawn_with_shell("pavolume +5%") end),
	awful.key({},"XF86AudioLowerVolume",function() awful.util.spawn_with_shell("pavolume -5%") end),
...
awful.rules.rules = {
    ...
    -- Open Web Browsers on the web tag
    { rule = {instance = "Navigator"},
        properties = {tag = tags[2],switchtotag=true}},
    {rule = {instance = "google-chrome"},
        properties = {tag=tags[2],switchtotag=true}},
    -- Open Spotify on Music
    {rule = {class="[Ss]potify"},
        properties = {tag = tags[6],switchtotag=true}},
    {rule_any = {instance={"code","jetbrains-pycharm"}},
        properties = {tag = tags[4],switchtotag=true}},
    {rule = {class="Steam"},
        properties = {tag = tags[5],switchtotag=true}},
    {rule_any = {instance={"slack","geary","microsoft teams - preview","discord"}},
	properties = {tag = tags[7],switchtotag=true,maximised=false}},
    {rule = {instance = "geary"},properties= {master_width_factor=0.75},callback=function(c) c:swap(awful.client.getmaster()) end }
}
-- }}}
...
client.connect_signal("manage", function (c)
     if c.class == nil then 
        c.minimized = true c:connect_signal("property::class", function () 
            c.minimized = false awful.rules.apply(c) end) 
        end 
    end)
     -- }}}
